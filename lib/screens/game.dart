...
//Projeto de estudo
//https://github.com/diegomarcelo-dev
//https://diegomarcelo.dev.br/
                        ...
                        children: [
                          Text(
                            ...
                            style: GoogleFonts.pacifico(
                                textStyle: TextStyle(
                                  fontSize: 50,
                                  color: matchedIndexes.contains(oScore)
                        ...
                        children: [
                          Text(
                            ...
                            style: GoogleFonts.pacifico(
                              textStyle: TextStyle(
                                fontSize: 50,
                                color: matchedIndexes.contains(xScore)
                                    ? MainColor.accentColor
                                    : MainColor.secondaryColor,
                              )
                            ),
  ...
  Widget _buildTimer() {
    ...
    return isRunning
      ...
      style: ElevatedButton.styleFrom(
          backgroundColor: MainColor.button,
